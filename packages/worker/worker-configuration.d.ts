/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 5a0e232aae8e9e49306b6f40b477d1db)
// Runtime types generated with workerd@1.20260603.1 2026-06-04 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	FILE_KV: KVNamespace;
	FILE_BUCKET: R2Bucket;
	ASSETS: Fetcher;
	ADMIN_JWT_SECRET: "file-share-dev-secret-change-in-production";
	SIGNALING: DurableObjectNamespace<import("./src/index").SignalingDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SignalingDO";
	}
